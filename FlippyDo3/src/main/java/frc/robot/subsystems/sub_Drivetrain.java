...
public class sub_Drivetrain extends PIDSubsystem {
  ...
  private final WPI_VictorSPX leftBackMotor = new WPI_VictorSPX(Constants.LEFT_SLAVE_CONTROLLER);
  private final WPI_TalonSRX leftFrontMotor = new WPI_TalonSRX(Constants.LEFT_MASTER_CONTROLLER);
  private final WPI_VictorSPX rightFrontMotor = new WPI_VictorSPX(Constants.RIGHT_MASTER_CONTROLLER);
  private final WPI_TalonSRX rightBackMotor = new WPI_TalonSRX(Constants.RIGHT_SLAVE_CONTROLLER);
  ...
  public sub_Drivetrain() {
    ...
    setDefaultCommand(new cmd_ArcadeDrive(this));
  }
